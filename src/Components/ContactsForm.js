...
import { useGetContactsQuery, useAddContactMutation } from '../Redux/API/contacts.API';
  ...
  const handleSubmit = e => {
    ...
    const isInContacts = ({ name, number }) => {
      ...
      return contacts.some(contact => {
        return contact.name.toLowerCase() === normalizedName || contact.phone === normalizedNumber;
      });
    };
